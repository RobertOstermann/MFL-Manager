...
connection.on("SetOptOuts", function (teams, selectedTeam) {
    ...
    var tornados = document.createElement("h4");
    ...
    var odbs = document.createElement("h4");
    odbs.classList.add("pb-2");
    odbs.id = "ODBs";
    odbs.innerHTML = "ODBs";
    var stormDynasty = document.createElement("h4");
    ...
    var power = document.createElement("h4");
    power.classList.add("pb-2");
    power.id = "Power";
    power.innerHTML = "Power";
    var ram = document.createElement("h4");
